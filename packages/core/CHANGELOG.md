...
- [`5e34107`](https://github.com/yuhengshen/ftjs/commit/5e34107ceba4031723f5b432f1b16ed7dbdfdb39) Thanks [@yuhengshen](https://github.com/yuhengshen)! - feat: `formatGetFormData` 新增第二个参数 `ctx`，支持获取 `fields` 拆分的原始值数组、完整表单数据和当前字段索引
